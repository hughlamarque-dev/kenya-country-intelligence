...
<summary>Build your case for donor support</summary>
<ol><li><strong>Define your funding case</strong><p>Choose a sector and county, or search your programme theme. Use <a href="#analysis" target="_parent">Country analysis</a> to support your assessment of need.</p></li>
<li><strong>Find donors that fit</strong><p>Compare funding history. Use <b>Partners &amp; routes</b> to check priorities, eligibility and how to approach each organisation.</p></li>
<li><strong>Explain your added value</strong><p>Use <b>Project evidence</b> and <b>Geography</b> to identify delivery partners and show how your proposal avoids duplication.</p></li></ol>
</details>'''
    ...
    context='''<div class="reading-context"><p id="selectionSummary" class="selection-summary"></p><details class="reading-note"><summary>How to read the figures</summary><p class="scope-note" id="scope"></p><p>Historical funding shows experience, not an available grant. Check the official source and current eligibility before approaching a partner.</p></details></div>'''
    ...
    html=html.replace('Explore funding histories, find partners working in your sector, and examine the evidence behind their Kenya portfolios.','Build a funding case around documented needs, donor priorities and a clear contribution alongside existing work.',1)
